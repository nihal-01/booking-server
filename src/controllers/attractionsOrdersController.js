      ...
      for (let i = 0; i < selectedActivities?.length; i++) {
        ...
        if (activity?.activityType === "transfer") {
          ...
          if (selectedActivities[i]?.transferType === "without") {
            ...
            if (b2cMarkup) {
              ...
              if (b2cMarkup.markupType === "flat") {
                ...
                markup = (b2cMarkup.markup * sharedTransferPrice) / 100;
              }
                ...
                if (
                  ...
                  if (b2cMarkup) {
                    ...
                    if (b2cMarkup.markupType === "flat") {
                      ...
                      markup = (b2cMarkup.markup * pvtTransferPrice) / 100;
                    }
          ...
          if (attraction.bookingType === "ticket") {
            ...
            if (
              childrenTickets < Number(selectedActivities[i]?.childrenCount)
            ) {
              if (
          ...
          if (Number(selectedActivities[i]?.adultsCount) > 0) {
            ...
            if (b2cMarkup) {
              ...
              if (b2cMarkup.markupType === "flat") {
                ...
                markup = (b2cMarkup.markup * adultActivityPrice) / 100;
              }
          ...
          if (Number(selectedActivities[i]?.childrenCount) > 0) {
            ...
            if (b2cMarkup) {
              ...
              if (b2cMarkup.markupType === "flat") {
                ...
                markup = (b2cMarkup.markup * childActivityPrice) / 100;
              }
          ...
          if (
            ...
            if (b2cMarkup) {
              ...
              if (b2cMarkup.markupType === "flat") {
                ...
                markup = (b2cMarkup.markup * infantActivityPrice) / 100;
              }
