...
module.exports = {
                    ...
                    $lookup: {
                        ...
                        pipeline: [
                            ...
                            // },
                            {
                                $addFields: {
                                    childTicketCount: {
                                        $ifNull: ["$ticketCounts.child", 0],
                                    },
                                    adultTicketCount: {
                                        $ifNull: ["$ticketCounts.adult", 0],
                                    },
                                    infantTicketCount: {
                                        $ifNull: ["$ticketCounts.infant", 0],
                                    },
                                    commonTicketCount: {
                                        $ifNull: ["$ticketCounts.common", 0],
                                    },
                                },
                            },
                            {
    ...
    getAllAttractions: async (req, res) => {
        try {
            ...
            console.log(attractions[0].data, "data");
