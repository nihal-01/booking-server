    ...
    try {
      ...
      for (let i = 0; i < selectedActivities?.length; i++) {
        ...
        if (attraction.bookingType === "ticket") {
          ...
          if (childrenTickets < selectedActivities[i]?.childrenCount) {
        ...
        if (selectedActivities[i]?.adultsCount > 0 && activity.adultPrice) {
          ...
          if (resellerToSubAgentMarkup) {
            ...
            if (resellerToSubAgentMarkup.markupType === "flat") {
              ...
              markup =
                (resellerToSubAgentMarkup.markup * activity.adultPrice) / 100;
            }

            totalResellerMarkup += markup * selectedActivities[i]?.adultsCount;
            adultPrice += markup;
          }
          ...
          if (resellerToClientMarkup) {
            ...
            if (resellerToClientMarkup.markupType === "flat") {
              ...
              markup = (resellerToClientMarkup.markup * adultPrice) / 100;
            }
            totalSubAgentMarkup += markup * selectedActivities[i]?.adultsCount;
            adultPrice += markup;
          }
        ...
        if (selectedActivities[i]?.childrenCount > 0 && activity.childPrice) {
          ...
          if (resellerToSubAgentMarkup) {
            ...
            if (resellerToSubAgentMarkup.markupType === "flat") {
              ...
              markup =
                (resellerToSubAgentMarkup.markup * activity?.childPrice) / 100;
            }
            totalResellerMarkup +=
          ...
          if (resellerToClientMarkup) {
            ...
            if (resellerToClientMarkup.markupType === "flat") {
              ...
              markup = (resellerToClientMarkup.markup * childPrice) / 100;
            }
            totalSubAgentMarkup +=
              markup * selectedActivities[i]?.childrenCount;
            childPrice += markup;
        ...
        if (selectedActivities[i]?.infantCount > 0 && activity.infantPrice) {
          ...
          if (resellerToSubAgentMarkup) {
            ...
            totalResellerMarkup += markup * selectedActivities[i]?.infantCount;
            infantPrice += markup;
          }
          ...
          if (resellerToClientMarkup) {
            ...
            if (resellerToClientMarkup.markupType === "flat") {
              ...
              markup = (resellerToClientMarkup.markup * infantPrice) / 100;
            }
            totalSubAgentMarkup += markup * selectedActivities[i]?.infantCount;
            infantPrice += markup;
          }
    ...
    try {
      ...
      for (let i = 0; i < attractionOrder.activities?.length; i++) {
        ...
        if (attractionOrder.activities[i].bookingType === "ticket") {
          ...
          for (let j = 0; j < attractionOrder.activities[i].adultsCount; j++) {
          ...
          totalPurchaseCost =
            activity.adultCost * attractionOrder.activities[i].adultsCount +
            (activity.childCost * attractionOrder.activities[i].childrenCount ||
              0) +
            (activity.infantCost *
              attractionOrder.activities[i].childrenCount || 0);
          attractionOrder.activities[i].status = "booked";
        }
        attractionOrder.activities[i].totalPurchaseCost = totalPurchaseCost;
