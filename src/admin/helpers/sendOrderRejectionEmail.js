    ...
    try {
          ...
          sendEmail(
            ...
            <div style="background-color: #f7f7f7; padding: 20px;">
              ...
              <p style="margin-top: 20px;">Unfortunately your order has been cancelled. Your order details are as follows:</p>
              <table style="width: 100%; margin-top: 20px; border-collapse: collapse;">
                ...
                <td style="padding: 10px; border: 1px solid #ddd;">${orderDetails.activities[0].amount}</td>
              </tr>
              </table>
