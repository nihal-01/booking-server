...
module.exports = {
  ...
  confirmBooking: async (req, res) => {
    try {
      const { orderId, bookingId, bookingConfirmationNumber, note, orderedBy } =
        req.body;
      ...
      if (orderedBy === "b2c") {
        ...
        await handleAttractionOrderMarkup(orderId, orderDetails?.activities[0]);
      }
      ...
      if (orderedBy === "b2c") {
        await AttractionOrder.findOneAndUpdate(
          ...
          },
          {
            ...
            "activities.$.refundAmount": orderDetails.activities[0].amount,
